...
// that sentence from two opposite places, and a live Explorer teach attempt refused with it while
...
// refusedGrounding is a teach session whose start was settled and could not be pointed at.
func refusedGrounding(d observe.ReferentDiagnosis) teach.Session {
	return teach.Session{
		Name: "open target", Phase: teach.ReadyForDemo, Application: "explorer",
...
// Grounding failure changes NOTHING about what teaching decided.
//
