...
// `rehearse`, `execute` or a platform package, and this is how it stays true while Learn still
...
//
// Learn gets one exempt rehearsal question, and the terminal leg claims it. Every other leg is
...
// Audience demonstrated and refused its own entry condition when asked from the start.
//
